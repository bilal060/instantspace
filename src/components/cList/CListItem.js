      ...
      <View
        ...
        <View
          style={[
            ...
            type === 'horizontal' && Styles.horizontalItemImageContainer,
            imageStyle,
          ]}>
          <ProgressiveImage
            source={image}
        ...
        <View
          ...
          {orderNumber ? (
            <CText style={Styles.listItemOrderNumber} numberOfLines={1}>
              {orderNumber}
            </CText>
          ) : null}
          ...
          {buttonText ? (
            <TouchableOpacity
              ...
              <CText style={Styles.listItemButtonText}>{buttonText}</CText>
            </TouchableOpacity>
          ) : null}
        </View>
